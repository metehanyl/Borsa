    ...
    Column {
        ...
        Row(verticalAlignment = androidx.compose.ui.Alignment.Bottom) {
            ...
            Text(
                ...
                fontSize = 15.sp,
                color = if (isPositive) com.metehanyl.borsa.ui.theme.BuyGreen else com.metehanyl.borsa.ui.theme.SellRed,
...
private fun AnalysisSection(analysis: Analysis) {
    Column(
        ...
        Row(verticalAlignment = androidx.compose.ui.Alignment.CenterVertically) {
            Text("Algoritmik Analiz", fontWeight = FontWeight.SemiBold, fontSize = 15.sp, modifier = Modifier.weight(1f))
...
private fun DisclaimerCard() {
    Text(
        text = "Bu ekrandaki skor ve yorumlar; hareketli ortalama, RSI, MACD, momentum ve 52 haftalık " +
            "aralık gibi standart teknik göstergelerin kural tabanlı biçimde ağırlıklandırılmasıyla " +
            "cihazınızda otomatik üretilir. Yatırım danışmanlığı değildir; yatırım kararlarınızı kendi " +
            "araştırmanız ve risk toleransınıza göre verin.",
        fontSize = 11.sp,
