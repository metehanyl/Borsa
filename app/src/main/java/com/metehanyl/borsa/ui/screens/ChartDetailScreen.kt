...
/**
 * Fiyat grafiğinin, hisse detay ekranındaki küçük haliyle sığmayan, daha
 * büyük ve daha rahat incelenebilen tam ekran hâli. Aynı veriyi/aynı
 * bileşeni (PriceChart) kullanır, sadece daha fazla ekran alanı ayırır.
 */
